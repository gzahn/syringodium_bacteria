...
# download csv files###
# collection dates by Wainwright
...
pulau_550_003 <- read_csv("./metadata/550-003_meantrend.csv")
...
lumut_550_005 <- read_csv("./metadata/550-005_meantrend.csv")
...
pelabuhan_550_007 <- read_csv("./metadata/550-007_meantrend.csv")
...
tan_kel_550_009 <- read_csv("./metadata/550-009_meantrend.csv")
...
tan_gel_550_014 <- read_csv("./metadata/550-014_meantrend.csv")
...
cendering_550_017 <- read_csv("./metadata/550-017_meantrend.csv")
